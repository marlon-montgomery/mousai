...
class CommonServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(CursorPaginator::class, AppCursorPaginator::class);
    ...
    private function normalizeRequestUri(Request $request)
    {
        ...
        if (preg_match('/^public/', ltrim($normalizedUri, '/'))) {
            return;
        }
    ...
    private function registerCustomValidators()
    {
        Validator::extend(
            'hash',
            'Common\Auth\Validators\HashValidator@validate',
        );
        Validator::extend(
            'email_verified',
    ...
    private function registerPolicies()
    {
        ...
        Gate::policy(
            ...
            NotificationSubscriptionPolicy::class,
        );
