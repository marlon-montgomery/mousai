...
use Common\Search\Controllers\ModelSearchController;
...
Route::group(['prefix' => 'secure', 'middleware' => 'web'], function () {
    ...
    // COMMENTS
    Route::apiResource('comment', 'Common\Comments\Controllers\CommentController');
    Route::post('comment/restore', 'Common\Comments\Controllers\CommentController@restore');
