 ...
 * @method static \Illuminate\Database\Eloquent\Builder|BillingPlan matches(array $columns, string $value)
 * @method static \Illuminate\Database\Eloquent\Builder|BillingPlan mysqlSearch(string $query)
 */
